...
import { Car, Calculator, Info, Mail, Menu, X } from 'lucide-react';
      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2 text-xl font-bold">
            ...
            <span className="hidden sm:inline">DentRepairCostEstimator.com</span>
            <span className="sm:hidden">DRCE</span>
          </Link>
